    ...
    sidebarPanel(
      ui <- fluidPage(
        selectInput("file1", "Choisir le corpus",
                    choices = c("Fichier 1" = "neybaf.github.io/gouez_f/R/data/file1.txt",
                                "Fichier 2" = "neybaf.github.io/gouez_f/R/data/file2.txt",
                                "Fichier 3" = "neybaf.github.io/gouez_f/R/data/file3.txt"),
                    multiple = TRUE),
