...
server <- function(input, output) {
  votesData <- eventReactive(input$search, {
    files <- list.files(path = "/Users/fabiengouez/Desktop/R_ET_ET_RMD/pol_depute/src16/votes", pattern = "*.xml", full.names = TRUE) # Adapter le chemin vers vos fichiers XML
